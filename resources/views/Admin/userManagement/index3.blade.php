                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style=" display: table-cell; vertical-align: middle; ">
                                                            ...
                                                            @elseif ($user->phanQuyen == 0)
                                                                <span
                                                                    style=" font-size: 10px; background-color: #ef5f0c !important; "
                                                                    class="badge badge-pill badge-success">Người dùng
                                                                </span>
                                            ...
                                            <tbody>
                                                @foreach ($userStudent as $user)
                                                    <tr>
                                                        ...
                                                        <td class="align-middle">
                                                            {{ $user->ngaySinh ? date('d-m-Y', strtotime($user->ngaySinh)) : null }}
                                                        </td>
                                                        <td class="align-middle">{{ $user->diaChi ? $user->diaChi : null }}
                                                        </td>
                                                    </tr>
                                                @endforeach
                                            </tbody>
